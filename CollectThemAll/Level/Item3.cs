...
namespace assignment_4
{
    public class Item3 : items
    {
        ...
        public Item3(Level currentLevel, Vector2 position)
        {
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            if (Game1.COLLISION_DEBUG)
            {
                ...
                simpleTexture.SetData(new Color[] { Color.LightGoldenrodYellow });
                spriteBatch.Draw(simpleTexture, BoundingBox(), Color.LightGoldenrodYellow);
            }
            else
            {
